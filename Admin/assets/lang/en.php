...
$language['Extracao'] = "Extração";
$language['NovaExtracao'] = "Nova extração";
$language['Historico'] = "Histórico";
$language['Administracao'] = "Administração";
$language['GestaoEmpresas'] = "Gestao de Empresas";
$language['GestaoUsuarios'] = "Gestao de Usuários";
...
$language['Shawn_L'] = $_SESSION['firstname'];;	
