            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Editar projetos</li>
                                </ol>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Selecione o projeto</h4>
                                <p class="card-title-desc">Selecione a empresa e o projeto que serão editados.</p>
                            </div>
                                                    ...
                                                    foreach ($empresas as $empresa) { ?>
                                                        <div class='form-check mb-3'>
                                                            <input
                                                                ...
                                                                id='formRadios<?php echo $empresa['name']; ?>'
                                                                value='<?php echo $empresa['id']; ?>'
                                                                <?php echo (isset($_POST['selectedEmpresa']) && $_POST['selectedEmpresa'] == $empresa) ? 'checked' : ''; ?>>
                                                            <label
                                                                class='form-check-label'
                                                                for='formRadios<?php echo $empresa['name']; ?>'
                                                                data-projetos='<?php echo json_encode($empresas['name']); ?>'>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Editar dados do projeto</h4>
                                <p class="card-title-desc">Altere os campos abaixo conforme a necessidade. Os dados que já estão preenchidos são aqueles registrados atualmente para o projeto selecionado.</p>
                            </div>
                            <div class="card-body p-4">
                                <div class="row">
                                    <form id="detalhesProjetoForm">
                                        ...
                                        <div class="row justify-content-end">
                                            <div class="col-lg-auto">
                                                <div class="mt-4">
                                                    <button type="submit" class="btn btn-primary w-lg">Confirmar edição do projeto</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
